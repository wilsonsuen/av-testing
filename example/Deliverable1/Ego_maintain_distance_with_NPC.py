...
MAX_POV_SPEED = 5  # (96 km/h, 60 mph)
...
POVState.transform = sim.map_point_on_lane(lgsvl.Vector(egoX  - 15.74, egoY , egoZ  +7.34))
POV = sim.add_agent("SchoolBus", lgsvl.AgentType.NPC, POVState)
#POV = sim.add_agent("Pamela", lgsvl.AgentType.PEDESTRIAN, POVState)
